...
new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".useful__slider", {
  slidesPerView: "auto",
  spaceBetween: 24,
  navigation: {
    prevEl: ".useful-prev",
...
new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".cases__slider", {
  slidesPerView: 1,
  spaceBetween: 20,
  navigation: {
    prevEl: ".case-prev",
...
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".contacts-form", rules1, checks1, afterForm);
